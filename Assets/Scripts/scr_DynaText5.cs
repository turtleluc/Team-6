...
public class scr_DynaText5 : MonoBehaviour
{
    ...
    private string[] txt = new string[]{
      ...
      "De man nam Steve in zich op. De jongen zat ineengedoken over zijn bekertje water heen. Zijn haar was onverzorgd en zijn handen waren zacht aan het trillen.", 
      "Steve: Ik uhm, uhm...",
